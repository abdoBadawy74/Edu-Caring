    ...
    <>
      <div className="commuinty d-flex gap-3 p-3">
        <div className={`chats ${showChatContent ? "d-none" : ""}`}>
          ...
          <div className="chat-item d-flex gap-2 p-2 position-relative active" onClick={handleChatItemClick}>
            <img
              src={chatImg}
              alt="chat-img"
              width={"60px"}
        ...
        <div className={`chat-content ${showChatContent ? "" : "d-none"}`}>
          ...
          <i className="fa-regular fa-circle-left back" onClick={handleBackClick}></i>
        </div>
      </div>
    </>
  );
